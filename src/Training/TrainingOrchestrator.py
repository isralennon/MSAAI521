...
class TrainingOrchestrator:
    ...
    def train_stage1_warmup(self, epochs=50, batch_size=4, img_size=1280):
        """
        ...
        Args:
            ...
            batch_size: Batch size (default: 4, optimized for 1280px images)
    ...
    def train_stage2_finetune(self, stage1_weights_path, epochs=150, batch_size=4, img_size=1280):
        """
